...
export default function({ node }) {
    return (
        <svg width="32px" viewBox="0 0 32 32">
            <path fill="#00BCD4" d="M26.3,1h-12L3.4,11.8v16.9c0,1.3,1.1,2.4,2.4,2.4h20.1h0.4c1.3,0,2.4-1.1,2.4-2.4v-0.3v-25 C28.6,2.1,27.6,1,26.3,1z"/>
            <polygon opacity="0.1" points="12.5,11.8 3.4,19.4 3.4,11.8 "/>
